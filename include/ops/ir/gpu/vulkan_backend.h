...
typedef struct CMLVulkanBackend {
    ...
    VkResult (*vkAllocateMemory)(VkDevice device, const void* pAllocInfo, const void* pAllocator,
    ...
    VkResult (*vkCreateBuffer)(VkDevice device, const void* pCreateInfo, const void* pAllocator,
                               VkBuffer* pBuffer);
    ...
    VkResult (*vkCreateFence)(VkDevice device, const void* pCreateInfo, const void* pAllocator,
                              VkFence* pFence);
    ...
    VkResult (*vkCreateDescriptorSetLayout)(VkDevice device, const void* pCreateInfo,
                                            const void* pAllocator, VkDescriptorSetLayout* pLayout);
    ...
    void (*vkUpdateDescriptorSets)(VkDevice device, uint32_t writeCount, const void* pWrites,
                                   uint32_t copyCount, const void* pCopies);

    void (*vkCmdBindPipeline)(VkCommandBuffer buf, int bindPoint, VkPipeline pipeline);
    void (*vkCmdBindDescriptorSets)(VkCommandBuffer buf, int bindPoint, VkPipelineLayout layout,
                                    uint32_t firstSet, uint32_t count, const VkDescriptorSet* pSets,
    ...
    void (*vkCmdCopyBuffer)(VkCommandBuffer buf, VkBuffer src, VkBuffer dst, uint32_t regionCount,
                            const void* pRegions);
