...
CML_API void torch_selective_build_enable_ops(TorchSelectiveBuildConfig* cfg, const UOpType* ops,
                                              int count);
...
CML_API int torch_selective_build_from_string(const char* spec, TorchSelectiveBuildConfig* out);

/* Derive required ops from a loaded .cpte program */
CML_API int torch_selective_build_from_pte(const char* pte_path, TorchSelectiveBuildConfig* out);

CML_API int torch_selective_build_save(const TorchSelectiveBuildConfig* cfg, const char* path);
CML_API int torch_selective_build_load(const char* path, TorchSelectiveBuildConfig* out);
