...
static int test_channels_rgba32f(void) { return cml_image_dtype_channels(CML_IMAGE_RGBA32F) == 4; }

static int test_channels_rg32f(void) { return cml_image_dtype_channels(CML_IMAGE_RG32F) == 2; }

static int test_channels_r32f(void) { return cml_image_dtype_channels(CML_IMAGE_R32F) == 1; }

static int test_bpp_rgba32f(void) { return cml_image_dtype_bpp(CML_IMAGE_RGBA32F) == 16; }

static int test_bpp_rgba8(void) { return cml_image_dtype_bpp(CML_IMAGE_RGBA8) == 4; }

static int test_bpp_r16f(void) { return cml_image_dtype_bpp(CML_IMAGE_R16F) == 2; }
