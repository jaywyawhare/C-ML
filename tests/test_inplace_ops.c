...
int main(void) {
    ...
    { float a[4] = {1,2,3,4}, b[4] = {10,20,30,40}, w[4] = {11,22,33,44};
      Tensor* ta = cml_tensor_1d(a, 4); Tensor* tb = cml_tensor_1d(b, 4);
    ...
    { float a[4] = {1,2,3,4}, s[1] = {3}, w[4] = {3,6,9,12};
      Tensor* ta = cml_tensor_1d(a, 4); Tensor* ts = cml_tensor_1d(s, 1);
      cml_mul_(ta, ts);
    ...
    { float a[3] = {5,7,9}, b[3] = {1,2,3}, w[3] = {4,5,6};
      Tensor* ta = cml_tensor_1d(a, 3); Tensor* tb = cml_tensor_1d(b, 3);
      cml_sub_(ta, tb);
    ...
    { float a[6] = {0,0,0, 1,1,1}, b[3] = {10,20,30}, w[6] = {10,20,30, 11,21,31};
      Tensor* ta = cml_tensor_2d(a, 2, 3); Tensor* tb = cml_tensor_1d(b, 3);
      cml_add_(ta, tb);
