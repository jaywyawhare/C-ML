...
static int test_create_with_spec(void) {
    CMLNullDevice* dev = cml_null_device_create_with_spec(8ULL * 1024 * 1024 * 1024, 500.0, 10.0);
    if (!dev)
        return 0;
...
static int test_estimate_time_compute_bound(void) {
    CMLNullDevice* dev = cml_null_device_create_with_spec(16ULL * 1024 * 1024 * 1024, 900.0, 19.5);
