...
static int test_devec_null(void) { return cml_devectorize(NULL) == -1; }
...
static int test_expand_null(void) { return cml_expand_groups(NULL) == -1; }
...
static int test_late_lower_null(void) { return cml_late_lower(NULL) == -1; }
