...
class Tensor:
    ...
    # Operators (accept a Tensor or a Python scalar, which is broadcast)
    ...
    def median(self, dim: Optional[int] = None) -> "Tensor": ...
    def unique(self) -> "Tensor": ...
    def masked_select(self, mask: Any) -> "Tensor": ...
    def pad(self, pad_widths: Any, mode: str = "constant",
...
def pad(x: Any, pad_widths: Any, mode: str = "constant",
        value: float = 0.0) -> Tensor: ...
def result_type(a: Any, b: Any) -> int: ...
def zeros(shape: Shape) -> Tensor: ...
def ones(shape: Shape) -> Tensor: ...
def randn(shape: Shape) -> Tensor: ...
def rand(shape: Shape) -> Tensor: ...
