...
int main(void) {
    ...
    module_set_training((Module*)G, true);
    module_set_training((Module*)D, true);
    ...
    for (int epoch = 1; epoch <= N_EPOCHS; epoch++) {
        ...
        tensor_free(real); tensor_free(d_real); tensor_free(label_real);
    ...
    module_set_training((Module*)G, false);
    module_set_training((Module*)D, false);
