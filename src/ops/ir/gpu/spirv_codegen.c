...
static void emit_scalar_types(SPIRVBuilder* b, uint32_t id_void, uint32_t id_bool, uint32_t id_uint,
                              uint32_t id_float, uint32_t id_uint3, uint32_t id_void_fn) {
...
static uint32_t emit_load_scalar(SPIRVBuilder* b, uint32_t type, uint32_t ptr_type, uint32_t var,
                                 uint32_t member) {
    uint32_t ptr = spirv_builder_alloc_id(b);
...
uint32_t* cml_spirv_gen_unary(CMLSPIRVCodegen* cg, UOpType op, const char* name, size_t* out_size) {
    ...
    uint32_t id_void = ids.id_void, id_bool = ids.id_bool, id_uint = ids.id_uint,
             id_float = ids.id_float, id_uint3 = ids.id_uint3, id_void_fn = ids.id_void_fn,
             id_rtarray_f = ids.id_rtarray;
    ...
    switch (op) {
    case UOP_NEG:
        emit_op(b, SpvOpFNegate, 4);
        spirv_builder_emit(b, id_float);
        spirv_builder_emit(b, id_result);
    ...
    case UOP_EXP:
        ...
        spirv_builder_emit(b, id_float);
        spirv_builder_emit(b, id_result);
        spirv_builder_emit(b, glsl_ext);
        spirv_builder_emit(b, GLSLstd450Exp);
        spirv_builder_emit(b, id_val);
        break;
    case UOP_LOG:
        emit_op(b, SpvOpExtInst, 6);
        ...
        spirv_builder_emit(b, id_result);
        spirv_builder_emit(b, glsl_ext);
        spirv_builder_emit(b, GLSLstd450Log);
        spirv_builder_emit(b, id_val);
        break;
    case UOP_SQRT:
        emit_op(b, SpvOpExtInst, 6);
        ...
        spirv_builder_emit(b, id_result);
        spirv_builder_emit(b, glsl_ext);
        spirv_builder_emit(b, GLSLstd450Sqrt);
        spirv_builder_emit(b, id_val);
        break;
    case UOP_ABS:
        emit_op(b, SpvOpExtInst, 6);
        ...
        spirv_builder_emit(b, id_result);
        spirv_builder_emit(b, glsl_ext);
        spirv_builder_emit(b, GLSLstd450FAbs);
        spirv_builder_emit(b, id_val);
        break;
    case UOP_SIN:
        emit_op(b, SpvOpExtInst, 6);
        ...
        spirv_builder_emit(b, id_result);
        spirv_builder_emit(b, glsl_ext);
        spirv_builder_emit(b, GLSLstd450Sin);
        spirv_builder_emit(b, id_val);
        break;
    case UOP_COS:
        emit_op(b, SpvOpExtInst, 6);
        ...
        spirv_builder_emit(b, id_result);
        spirv_builder_emit(b, glsl_ext);
        spirv_builder_emit(b, GLSLstd450Cos);
        spirv_builder_emit(b, id_val);
        break;
    case UOP_TAN:
        emit_op(b, SpvOpExtInst, 6);
        ...
        spirv_builder_emit(b, id_result);
        spirv_builder_emit(b, glsl_ext);
        spirv_builder_emit(b, GLSLstd450Tan);
        spirv_builder_emit(b, id_val);
        break;
    case UOP_TANH:
        emit_op(b, SpvOpExtInst, 6);
        ...
        spirv_builder_emit(b, id_result);
        spirv_builder_emit(b, glsl_ext);
        spirv_builder_emit(b, GLSLstd450Tanh);
        spirv_builder_emit(b, id_val);
        break;
    case UOP_RECIP: {
        uint32_t id_one = emit_float_constant(b, id_float, 1.0f);
        emit_op(b, SpvOpFDiv, 5);
        spirv_builder_emit(b, id_float);
        spirv_builder_emit(b, id_result);
        spirv_builder_emit(b, id_one);
        spirv_builder_emit(b, id_val);
        break;
    }
    case UOP_EXP2:
        ...
        spirv_builder_emit(b, id_result);
        spirv_builder_emit(b, glsl_ext);
        spirv_builder_emit(b, GLSLstd450Exp2);
        spirv_builder_emit(b, id_val);
        break;
    case UOP_LOG2:
        emit_op(b, SpvOpExtInst, 6);
        ...
        spirv_builder_emit(b, id_result);
        spirv_builder_emit(b, glsl_ext);
        spirv_builder_emit(b, GLSLstd450Log2);
        spirv_builder_emit(b, id_val);
        break;
    case UOP_RSQRT:
        emit_op(b, SpvOpExtInst, 6);
        ...
        spirv_builder_emit(b, id_result);
        spirv_builder_emit(b, glsl_ext);
        spirv_builder_emit(b, GLSLstd450InverseSqrt);
        spirv_builder_emit(b, id_val);
        break;
    case UOP_FLOOR:
        emit_op(b, SpvOpExtInst, 6);
        ...
        spirv_builder_emit(b, id_result);
        spirv_builder_emit(b, glsl_ext);
        spirv_builder_emit(b, GLSLstd450Floor);
        spirv_builder_emit(b, id_val);
        break;
    case UOP_CEIL:
        emit_op(b, SpvOpExtInst, 6);
        ...
        spirv_builder_emit(b, id_result);
        spirv_builder_emit(b, glsl_ext);
        spirv_builder_emit(b, GLSLstd450Ceil);
        spirv_builder_emit(b, id_val);
        break;
    case UOP_SIGN:
        emit_op(b, SpvOpExtInst, 6);
        ...
        spirv_builder_emit(b, id_result);
        spirv_builder_emit(b, glsl_ext);
        spirv_builder_emit(b, GLSLstd450FSign);
        spirv_builder_emit(b, id_val);
        break;
    default:
...
uint32_t* cml_spirv_gen_binary(CMLSPIRVCodegen* cg, UOpType op, const char* name,
    ...
    case UOP_ADD:
        ...
        spirv_builder_emit(b, id_float);
        spirv_builder_emit(b, id_res);
        spirv_builder_emit(b, id_a);
        spirv_builder_emit(b, id_bv);
        break;
    case UOP_SUB:
        emit_op(b, SpvOpFSub, 5);
        spirv_builder_emit(b, id_float);
        spirv_builder_emit(b, id_res);
        spirv_builder_emit(b, id_a);
        spirv_builder_emit(b, id_bv);
    ...
    case UOP_MAX:
        ...
        spirv_builder_emit(b, id_res);
        spirv_builder_emit(b, glsl_ext);
        spirv_builder_emit(b, GLSLstd450FMax);
        spirv_builder_emit(b, id_a);
        spirv_builder_emit(b, id_bv);
        break;
    case UOP_MINIMUM:
        ...
        spirv_builder_emit(b, id_res);
        spirv_builder_emit(b, glsl_ext);
        spirv_builder_emit(b, GLSLstd450FMin);
        spirv_builder_emit(b, id_a);
        spirv_builder_emit(b, id_bv);
        break;
    case UOP_POW:
        ...
        spirv_builder_emit(b, id_res);
        spirv_builder_emit(b, glsl_ext);
        spirv_builder_emit(b, GLSLstd450Pow);
        spirv_builder_emit(b, id_a);
        spirv_builder_emit(b, id_bv);
        break;
    default:
...
uint32_t* cml_spirv_gen_reduction(CMLSPIRVCodegen* cg, UOpType op, const char* name,
    ...
    emit_op(b, SpvOpTypeArray, 4);
    spirv_builder_emit(b, id_arr_256);
    spirv_builder_emit(b, id_float);
    spirv_builder_emit(b, id_const_256u);
    ...
    uint32_t id_mem_sem  = emit_uint_constant(
        b, id_uint, SpvMemorySemanticsWorkgroupMemoryMask | SpvMemorySemanticsAcquireReleaseMask);
    ...
    emit_op(b, SpvOpULessThan, 5);
    spirv_builder_emit(b, id_bool);
    spirv_builder_emit(b, id_cmp_bounds);
    spirv_builder_emit(b, id_gid_x);
    spirv_builder_emit(b, id_n);
    ...
    emit_op(b, SpvOpSelectionMerge, 3);
    spirv_builder_emit(b, id_label_merge);
    spirv_builder_emit(b, 0);
    emit_op(b, SpvOpBranchConditional, 4);
    spirv_builder_emit(b, id_cmp_bounds);
    spirv_builder_emit(b, id_label_load);
    spirv_builder_emit(b, id_label_skip);

    /* Load path: load inBuf.data[gid] */
    emit_label(b, id_label_load);
    uint32_t id_loaded_val =
        emit_load_element(b, id_float, id_ptr_sb_f, id_var_in, id_const_0u, id_gid_x);
    emit_op(b, SpvOpBranch, 2);
    spirv_builder_emit(b, id_label_merge);
    ...
    emit_op(b, SpvOpPhi, 7);
    spirv_builder_emit(b, id_float);
    spirv_builder_emit(b, id_init_val);
    spirv_builder_emit(b, id_loaded_val);
    spirv_builder_emit(b, id_label_load);
    ...
    for (int step = 0; step < 8; step++) {
        ...
        emit_op(b, SpvOpBranchConditional, 4);
        spirv_builder_emit(b, id_cmp_s);
        spirv_builder_emit(b, id_lbl_reduce);
        spirv_builder_emit(b, id_lbl_skip2);
        ...
        emit_op(b, SpvOpFAdd, 5);
        spirv_builder_emit(b, id_float);
        spirv_builder_emit(b, id_sum);
        spirv_builder_emit(b, id_sd_val1);
    ...
    emit_op(b, SpvOpULessThan, 5);
    spirv_builder_emit(b, id_bool);
    spirv_builder_emit(b, id_cmp_zero);
    spirv_builder_emit(b, id_tid);
    ...
    emit_op(b, SpvOpBranchConditional, 4);
    spirv_builder_emit(b, id_cmp_zero);
    spirv_builder_emit(b, id_lbl_write);
    spirv_builder_emit(b, id_lbl_end);
    ...
    if (op == UOP_MEAN) {
        ...
        emit_op(b, SpvOpFDiv, 5);
        spirv_builder_emit(b, id_float);
        spirv_builder_emit(b, id_final_val);
        spirv_builder_emit(b, id_res_val);
        spirv_builder_emit(b, id_n_float);
    }
...
uint32_t* cml_spirv_gen_matmul(CMLSPIRVCodegen* cg, const char* name, size_t* out_size) {
    ...
    uint32_t id_ptr_sb_u  = spirv_builder_alloc_id(b);
    uint32_t id_ptr_in_u3 = spirv_builder_alloc_id(b);
    uint32_t id_ptr_fn_f =
        spirv_builder_alloc_id(b); /* Function ptr to float (for loop accumulator) */
    ...
    emit_op(b, SpvOpTypeStruct, 5);
    spirv_builder_emit(b, id_struct_p);
    spirv_builder_emit(b, id_uint);
    spirv_builder_emit(b, id_uint);
    spirv_builder_emit(b, id_uint);
    ...
    emit_op(b, SpvOpVariable, 5);
    spirv_builder_emit(b, id_ptr_fn_f);
    spirv_builder_emit(b, id_var_sum);
    spirv_builder_emit(b, SpvStorageClassFunction);
    spirv_builder_emit(b, id_const_0f);
    ...
    emit_op(b, SpvOpULessThan, 5);
    spirv_builder_emit(b, id_bool);
    spirv_builder_emit(b, id_cmp_row);
    spirv_builder_emit(b, id_row);
    ...
    emit_op(b, 167 /* SpvOpLogicalAnd */, 5);
    spirv_builder_emit(b, id_bool);
    spirv_builder_emit(b, id_cmp_both);
    spirv_builder_emit(b, id_cmp_row);
    spirv_builder_emit(b, id_cmp_col);
    ...
    emit_op(b, SpvOpBranch, 2);
    spirv_builder_emit(b, id_lbl_loop_hdr);
    ...
    emit_op(b, SpvOpULessThan, 5);
    spirv_builder_emit(b, id_bool);
    spirv_builder_emit(b, id_cmp_k);
    spirv_builder_emit(b, id_k);
    spirv_builder_emit(b, id_K);

    emit_op(b, SpvOpBranchConditional, 4);
    spirv_builder_emit(b, id_cmp_k);
    spirv_builder_emit(b, id_lbl_loop_body);
    spirv_builder_emit(b, id_lbl_loop_end);
    ...
    emit_op(b, SpvOpIMul, 5);
    spirv_builder_emit(b, id_uint);
    spirv_builder_emit(b, id_row_k);
    spirv_builder_emit(b, id_row);
    spirv_builder_emit(b, id_K);
    uint32_t id_a_idx = spirv_builder_alloc_id(b);
    emit_op(b, SpvOpIAdd, 5);
    spirv_builder_emit(b, id_uint);
    spirv_builder_emit(b, id_a_idx);
    spirv_builder_emit(b, id_row_k);
    spirv_builder_emit(b, id_k);

    /* Load A[row * K + k] */
    uint32_t id_a_val =
        emit_load_element(b, id_float, id_ptr_sb_f, id_var_a, id_const_0u, id_a_idx);
    /* Compute index for B: k * N + col */
    uint32_t id_k_n = spirv_builder_alloc_id(b);
    emit_op(b, SpvOpIMul, 5);
    spirv_builder_emit(b, id_uint);
    spirv_builder_emit(b, id_k_n);
    spirv_builder_emit(b, id_k);
    spirv_builder_emit(b, id_N);
    uint32_t id_b_idx = spirv_builder_alloc_id(b);
    emit_op(b, SpvOpIAdd, 5);
    spirv_builder_emit(b, id_uint);
    spirv_builder_emit(b, id_b_idx);
    spirv_builder_emit(b, id_k_n);
    spirv_builder_emit(b, id_col);

    /* Load B[k * N + col] */
    uint32_t id_b_val =
        emit_load_element(b, id_float, id_ptr_sb_f, id_var_b, id_const_0u, id_b_idx);
    /* sum += A[...] * B[...] */
    uint32_t id_prod = spirv_builder_alloc_id(b);
    emit_op(b, SpvOpFMul, 5);
    spirv_builder_emit(b, id_float);
    spirv_builder_emit(b, id_prod);
    spirv_builder_emit(b, id_a_val);
    spirv_builder_emit(b, id_b_val);
    uint32_t id_sum_next = spirv_builder_alloc_id(b);
    emit_op(b, SpvOpFAdd, 5);
    spirv_builder_emit(b, id_float);
    spirv_builder_emit(b, id_sum_next);
    spirv_builder_emit(b, id_sum_phi);
    spirv_builder_emit(b, id_prod);
    ...
    emit_op(b, SpvOpIAdd, 5);
    spirv_builder_emit(b, id_uint);
    spirv_builder_emit(b, id_k_next);
    spirv_builder_emit(b, id_k);
    ...
    emit_op(b, SpvOpIMul, 5);
    spirv_builder_emit(b, id_uint);
    spirv_builder_emit(b, id_row_n);
    spirv_builder_emit(b, id_row);
    spirv_builder_emit(b, id_N);
    uint32_t id_c_idx = spirv_builder_alloc_id(b);
    emit_op(b, SpvOpIAdd, 5);
    spirv_builder_emit(b, id_uint);
    spirv_builder_emit(b, id_c_idx);
    spirv_builder_emit(b, id_row_n);
    spirv_builder_emit(b, id_col);
